...
const generatePosts = (users) => {
  const posts = [
    { projectId: 1, category: 'PROJECT', title: '배달 앱 클론 코딩하실 분!', recruitCount: 4, currentCount: 1, endDate: '2026-05-10', onOffline: '온라인', techStacks: ['React', 'Node.js', 'MySQL'], content: '실무와 유사한 환경에서 API 설계부터 배포까지 경험해봐요.', ownerNickname: '풀스택꿈나무', status: 'RECRUITING' },
    { projectId: 2, category: 'STUDY', title: '모던 자바스크립트 Deep Dive', recruitCount: 5, currentCount: 2, endDate: '2026-04-25', onOffline: '오프라인', techStacks: ['JavaScript'], content: '매주 한 장씩 읽고 정리해서 발표하는 스터디입니다. 강남역 선호!', ownerNickname: '프론트깍이', status: 'RECRUITING' },
    { projectId: 3, category: 'PROJECT', title: 'AI 기반 식단 추천 서비스', recruitCount: 3, currentCount: 1, endDate: '2026-06-15', onOffline: '혼합', techStacks: ['Python', 'FastAPI', 'PyTorch'], content: '사용자의 취향을 분석해 식단을 추천해주는 웹 서비스를 만듭니다.', ownerNickname: '최종보스', status: 'RECRUITING' },
    { projectId: 4, category: 'STUDY', title: 'Next.js 14 공식 문서 정독', recruitCount: 2, currentCount: 1, endDate: '2026-05-01', onOffline: '온라인', techStacks: ['Next.js', 'TypeScript'], content: 'App Router 기반의 신기능을 함께 학습하고 실습해봅니다.', ownerNickname: '넥스트레벨', status: 'DEADLINE_SOON' },
    { projectId: 5, category: 'PROJECT', title: '위치 기반 중고 거래 플랫폼', recruitCount: 6, currentCount: 2, endDate: '2026-07-20', onOffline: '오프라인', techStacks: ['Flutter', 'Firebase', 'Dart'], content: '동네 인증 기반의 하이퍼 로컬 커뮤니티 앱 프로젝트입니다.', ownerNickname: '앱개발자', status: 'RECRUITING' },
    { projectId: 6, category: 'STUDY', title: '스프링 부트 핵심 원리 파악', recruitCount: 4, currentCount: 3, endDate: '2026-05-05', onOffline: '온라인', techStacks: ['Spring Boot', 'Java'], content: '인프런 강의를 듣고 매주 코드 리뷰를 진행하는 스터디입니다.', ownerNickname: '백엔드장인', status: 'RECRUITING' },
    { projectId: 7, category: 'PROJECT', title: '디자이너를 위한 포트폴리오 사이트', recruitCount: 2, currentCount: 1, endDate: '2026-05-30', onOffline: '혼합', techStacks: ['Figma', 'React', 'Framer'], content: '감각적인 인터랙션이 들어간 디자이너 전용 템플릿 빌더입니다.', ownerNickname: '디자인천재', status: 'RECRUITING' },
    { projectId: 8, category: 'STUDY', title: '알고리즘 문제 풀이 (코테 대비)', recruitCount: 8, currentCount: 4, endDate: '2026-06-01', onOffline: '온라인', techStacks: ['Python', 'C++', 'Java'], content: '프로그래머스 레벨 2~3 문제를 매일 1개씩 풀고 인증합니다.', ownerNickname: '백엔드장인', status: 'RECRUITING' },
    { projectId: 9, category: 'PROJECT', title: '실시간 주식 차트 분석 대시보드', recruitCount: 3, currentCount: 1, endDate: '2026-06-25', onOffline: '온라인', techStacks: ['Vue.js', 'Go', 'WebSockets'], content: '대용량 데이터를 실시간으로 시각화하는 고성능 차트를 구현합니다.', ownerNickname: '고데이터', status: 'RECRUITING' },
    { projectId: 10, category: 'STUDY', title: '테라폼으로 배우는 IaC', recruitCount: 3, currentCount: 1, endDate: '2026-05-12', onOffline: '혼합', techStacks: ['Terraform', 'AWS'], content: '클라우드 인프라를 코드로 관리하는 방법을 함께 연구해요.', ownerNickname: '데브옵스왕', status: 'RECRUITING' },
    { projectId: 11, category: 'PROJECT', title: '대학생 전용 캘린더 공유 서비스', recruitCount: 4, currentCount: 2, endDate: '2026-08-10', onOffline: '오프라인', techStacks: ['React', 'NestJS', 'PostgreSQL'], content: '시간표와 과제 일정을 친구들과 공유하는 유틸리티 앱입니다.', ownerNickname: '네스트고수', status: 'RECRUITING' },
    { projectId: 12, category: 'STUDY', title: '피그마 컴포넌트 마스터하기', recruitCount: 5, currentCount: 2, endDate: '2026-04-30', onOffline: '온라인', techStacks: ['Figma'], content: '디자인 시스템의 기초인 컴포넌트와 변수 기능을 공부합니다.', ownerNickname: 'UI구조대', status: 'RECRUITING' },
    { projectId: 13, category: 'PROJECT', title: 'Rust로 만드는 웹 어셈블리 게임', recruitCount: 2, currentCount: 1, endDate: '2026-09-01', onOffline: '온라인', techStacks: ['Rust', 'Webpack'], content: '브라우저에서 돌아가는 고성능 로그라이크 게임 프로젝트입니다.', ownerNickname: '게임개발', status: 'RECRUITING' },
    { projectId: 14, category: 'STUDY', title: '쿠버네티스 실무 적용기', recruitCount: 4, currentCount: 2, endDate: '2026-05-20', onOffline: '혼합', techStacks: ['Kubernetes', 'Docker'], content: '로컬 환경에 클러스터를 구축하고 배포 파이프라인을 실습합니다.', ownerNickname: '인프라요정', status: 'RECRUITING' },
    { projectId: 15, category: 'PROJECT', title: '여행 사진 자동 보정 & 공유 플랫폼', recruitCount: 3, currentCount: 1, endDate: '2026-07-05', onOffline: '온라인', techStacks: ['Kotlin', 'Swift', 'OpenCV'], content: '필터 자동 추천 기능이 포함된 여행 커뮤니티 앱입니다.', ownerNickname: '코틀린러버', status: 'RECRUITING' },
    { projectId: 16, category: 'STUDY', title: 'SQL 튜닝 및 DB 설계 스터디', recruitCount: 6, currentCount: 3, endDate: '2026-06-10', onOffline: '오프라인', techStacks: ['MySQL', 'Oracle'], content: '성능 최적화를 위한 쿼리 튜닝 기법을 실제 사례로 공부합니다.', ownerNickname: '보안전문가', status: 'RECRUITING' },
    { projectId: 17, category: 'PROJECT', title: '개발자 전용 커피챗 서비스', recruitCount: 4, currentCount: 2, endDate: '2026-06-30', onOffline: '온라인', techStacks: ['TypeScript', 'Express', 'Redis'], content: '매칭 알고리즘을 통한 1:1 기술 교류 서비스를 만듭니다.', ownerNickname: '네스트고수', status: 'RECRUITING' },
    { projectId: 18, category: 'STUDY', title: '클린 코드 & 리팩토링 스터디', recruitCount: 3, currentCount: 1, endDate: '2026-05-15', onOffline: '혼합', techStacks: ['Java', 'Python'], content: "로버트 마틴의 '클린 코드' 책을 읽고 본인 코드를 리뷰합니다.", ownerNickname: '백엔드장인', status: 'RECRUITING' },
    { projectId: 19, category: 'PROJECT', title: '시니어 세대를 위한 커뮤니티', recruitCount: 5, currentCount: 2, endDate: '2026-08-20', onOffline: '오프라인', techStacks: ['React', 'Spring Boot', 'AWS'], content: '큰 글씨와 쉬운 UI를 강조한 세대 맞춤형 소셜 네트워크입니다.', ownerNickname: '프론트깍이', status: 'RECRUITING' },
    { projectId: 20, category: 'STUDY', title: '지라/노션 활용 협업 프로세스', recruitCount: 4, currentCount: 2, endDate: '2026-04-28', onOffline: '온라인', techStacks: ['Jira', 'Notion', 'Slack'], content: '프로젝트 관리 툴을 효율적으로 사용하는 노하우를 공유합니다.', ownerNickname: '기획마스터', status: 'DEADLINE_SOON' },
    ...
    { projectId: 34, category: 'STUDY', title: '다트(Dart) & 플러터 입문', recruitCount: 5, currentCount: 2, endDate: '2026-04-20', onOffline: '혼합', techStacks: ['Flutter', 'Dart', 'Firebase'], content: '모바일 앱 개발이 처음인 분들과 함께 기초부터 다지는 스터디.', ownerNickname: '앱개발자', status: 'DEADLINE_SOON' },
