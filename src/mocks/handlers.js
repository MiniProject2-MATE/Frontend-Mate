...
const generatePosts = (users) => {
  const posts = [
    ...
    // --- [DEADLINE_SOON] 날짜가 3일 남은 모집글 (3개) ---
    ...
    // --- [DEADLINE_SOON] 날짜가 2일 남은 모집글 (2개) ---
    ...
    // --- [DEADLINE_SOON] 날짜가 1일 남은 모집글 (2개) ---
    ...
    // --- [DEADLINE_SOON] 인원이 1명 남은 모집글 (3개) ---
